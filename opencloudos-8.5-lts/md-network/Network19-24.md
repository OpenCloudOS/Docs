...
![authenticator-802-1x](../../.gitbook/assets/authenticator-802-1x.png)
...
3. 设置 IPv4 默认网关。
![nm-connection-editor配置网关_1](../../.gitbook/assets/nm-connection-editor配置网关_1.png)
4. 设置 IPv6 默认网关。
![nm-connection-editor配置网关_2](../../.gitbook/assets/nm-connection-editor配置网关_2.png)
5. 点击 Save 。
...
2. 设置 IPv4 默认网关。
![control-center配置网关_1](../../.gitbook/assets/control-center配置网关_1.png)
3. 设置 IPv6 默认网关。
![control-center配置网关_2](../../.gitbook/assets/control-center配置网关_2.png)
4. 点击 Apply 。
...
更多详情，请参见以下示意图中的说明。
![routing-example](../../.gitbook/assets/routing-example.png)
...
![control-center配置静态路由](../../.gitbook/assets/control-center配置静态路由.png)
4. 点击 Apply 。
...
![nm-connection-editor配置静态路由](../../.gitbook/assets/nm-connection-editor配置静态路由.png)
6. 点击 OK 。
7. 点击 Save 。
8. 重启网络应用更改。
    ```
...
流程网络拓扑如下图：
![policy-based-routing](../../.gitbook/assets/policy-based-routing.png)
...
流程网络拓扑如下所示：
![](../../.gitbook/assets/policy-based-routing.png)
