...
4. 在 Team 选项卡中：
   ...
   ![nm-connection-editor配置team_1](./../../.gitbook/assets/nm-connection-editor配置team_1.png)
...
5. 配置团队的 IP 设置。如果要使用这个团队作为其它设备的端口，请跳过这一步。
   ...
   ![nm-connection-editor配置team_2](./../../.gitbook/assets/nm-connection-editor配置team_2.png)
   2. 在 IPv6 Settings 选项卡中，配置 IPv6 设置。例如，设置静态 IPv6 地址、网络掩码、默认网关、DNS 服务器和 DNS 搜索域：
   ![nm-connection-editor配置team_3](./../../.gitbook/assets/nm-connection-editor配置team_3.png)
6. 保存团队连接。
...
4. 在 Bond 选项卡中：
   ...
   ![nm-connection-editor配置bond_1](./../../.gitbook/assets/nm-connection-editor配置bond_1.png)
   4. 可选：设置其他选项，如介质独立接口（MII）监控间隔。
5. 配置绑定的 IP 设置。如果要使用这个绑定作为其它设备的端口，请跳过这一步。
   1. 在 IPv4 Settings 选项卡中，配置 IPv4 设置。例如，设置静态 IPv4 地址、网络掩码、默认网关、DNS 服务器和 DNS 搜索域：
   ![nm-connection-editor配置bond_2](./../../.gitbook/assets/nm-connection-editor配置bond_2.png)
   2. 在 IPv4 Settings 选项卡中，配置 IPv4 设置。例如，设置静态 IPv4 地址、网络掩码、默认网关、DNS 服务器和 DNS 搜索域：
   ![nm-connection-editor配置bond_3](./../../.gitbook/assets/nm-connection-editor配置bond_3.png)
6. 点 Save 保存绑定连接。
7. 关闭 nm-connection-editor。
...
5. 选择 Identity 菜单条目来查看基本配置选项：
    ...
    ![control-center配置VPN_1](../../.gitbook/assets/control-center配置VPN_1.png)
    以下配置设置在 高级 部分中提供：
    - Identification
      - domain 如果需要，输入域名。
    - Security
    ...
    ![control-center配置VPN_2](../../.gitbook/assets/control-center配置VPN_2.png)
6. 选择 IPv4 菜单条目：
    - IPv4 Method
...
4. 在 VPN 选项卡中：
   ...
   ![nm-connection-editor配置VPN_1](./../../.gitbook/assets/nm-connection-editor配置VPN_1.png)
...
![nm-connection-editor配置VPN_2](../../.gitbook/assets/nm-connection-editor配置VPN_2.png)
6. 保存设置。
7. 关闭 nm-connection-editor。
...
![IPIP-tunnel](./../../.gitbook/assets/IPIP-tunnel.png)
...
![GRE-tunnel](../../.gitbook/assets/GRE-tunnel.png)
...
![GRETAP-tunnel](../../.gitbook/assets/GRETAP-tunnel.png)
